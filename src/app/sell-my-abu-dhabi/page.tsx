...
export const metadata: Metadata = {
    title: 'Sell My Car in Abu Dhabi | Sell Any Car in Abu Dhabi in 30 Minutes',
    description: 'Sell any car in Abu Dhabi to Expat Car Buyers and get best cash deal for your used car. Sell your car in just 30 minutes and get instant payment.',
};
                    ...
                    <div className="landing-hero-content relative">
                        <div className="wow fadeInLeft" data-wow-delay="0.1s">
                            ...
                            <p className="text-lg text-gray-600 mb-10 max-w-lg leading-relaxed font-medium">
                                Sell Any Car in Abu Dhabi in 30 Minutes. Simply fill out the form below.
                            </p>
                        </div>
                ...
                <div className="max-w-6xl mx-auto px-4 md:px-8">
                    <div className="flex flex-col md:flex-row gap-16">
                        <div className="flex-1 space-y-12">
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900 mb-6">How to Sell a Car in <span className="text-[#f24026]">Abu Dhabi</span></h2>
                                <p className="text-gray-600 leading-relaxed text-lg">
                                    With so many options, you need to stand out from the crowd of other sellers in Abu Dhabi who also sell similar cars. At the end of the day, you have to decide whether to sell privately or take the easiest route and accept a dealer&apos;s price. You can sell a car in Abu Dhabi privately in various ways.
                                </p>
                            </div>
                            
                            <div>
                                <h2 className="text-3xl font-bold text-gray-900 mb-6">Why should I choose Expat Car Buyers?</h2>
                                <p className="text-gray-600 leading-relaxed mb-6">
                                    Thanks to the straightforward selling process at Expat Car Buyers, you can always sell any car Abu Dhabi. We often offer the highest price on the market because we respect the seller&apos;s time and want to buy their car.
                                </p>
                                <div className="grid grid-cols-2 gap-4">
                                    {['Simple approach', 'Fully secure procedure', '100% transparency', 'Definite purchase'].map(g => (
                        ...
                        <div className="flex-1 space-y-12">
                            <div className="bg-white p-8 rounded-[2.5rem] shadow-xl border border-[#FFD0C9]">
                                <h3 className="text-xl font-bold text-gray-900 mb-6 uppercase tracking-wider">Entire Selling Procedure</h3>
                                <div className="space-y-6">
                                    {[
                                        { title: 'Free Valuation', desc: 'We assign you a custom quote according to the current market price.' },
                                        { title: 'Transfer ownership', desc: 'If you proceed with the offer, we’ll take the ownership from you.' },
                                        { title: 'Payment clearance', desc: 'We also clear vehicle debt and set it with a reasonable margin.' },
                                        { title: 'Super-fast payment', desc: 'Bank transfer, cheque, etc. in a maximum of 30 minutes.' }
                                    ].map(p => (
                                        <div key={p.title}>
                            ...
                            <div>
                                <h2 className="text-2xl font-bold text-gray-900 mb-4 italic">&ldquo;What people are saying?&rdquo;</h2>
                                <TestimonialCarousel />
                            </div>
                        </div>
                    </div>
